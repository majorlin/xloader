# 
# Project automation script for xloader 
# 
# Created for ISE version 13.2
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source xloader.tcl), then you can
...
set myProject "xloader"
set myScript "xloader.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../../rtl/gpio.v"
   xfile add "../../rtl/picorv32.v"
   xfile add "../../rtl/sirv_qspi_4cs.v"
   xfile add "../../rtl/sirv_qspi_4cs_top.v"
   xfile add "../../rtl/sirv_qspi_fifo.v"
   xfile add "../../rtl/sirv_qspi_media_1.v"
   xfile add "../../rtl/sirv_qspi_physical_1.v"
   xfile add "../../rtl/sirv_queue_1.v"
   xfile add "../../rtl/sirv_uart.v"
   xfile add "../../rtl/sirv_uart_top.v"
...
proc set_process_props {} {
   ...
   project set "Working Directory" "/home/imxrt_1070_nobk/major_nxa17659/xloader/fpga/xloader"
   ...
   project set "Work Directory" "/home/imxrt_1070_nobk/major_nxa17659/xloader/fpga/xloader/xst" -process "Synthesize - XST"
